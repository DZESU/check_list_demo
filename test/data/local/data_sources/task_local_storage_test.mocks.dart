...
// in check_list_demo/test/data/local/data_sources/task_local_storage_test.dart.
...
class MockStorageService<T> extends _i1.Mock implements _i3.StorageService<T> {
  MockStorageService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i2.Future<bool> remove(dynamic key) => (super.noSuchMethod(
        Invocation.method(
          #remove,
          [key],
        ),
  ...
  @override
  _i2.Future<T?> get(dynamic key) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [key],
        ),
  ...
  @override
  _i2.Future<List<T>?> getAll() => (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
        ),
  ...
  @override
  _i2.Future<bool> has(dynamic key) => (super.noSuchMethod(
        Invocation.method(
          #has,
          [key],
        ),
